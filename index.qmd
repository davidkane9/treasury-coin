...
* We still use dollars. Federal workers are paid in dollars. Social security checks are denominated in dollars. The value of T-coins will float relative to dollars. The USG could bring some stability to the value of T-coins by having a regular off-chain [auction](auction.html), similar to the auctions which the US Treasury currently holds for new debt issuance.
