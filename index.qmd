...
* The Government could support the project by allowing people and business to pay their taxes with T-coin. Allowing, or even requiring, the use of a new currency for paying taxes is a tried and true method for governments throughout history to incentivise use of a new currency.
...
How much might T-coin help the US? Note that Dogecoin, a digital currency based on the Bitcoin protocol but created initially as a joke, has a market cap of around \$64 billion. If Bitcoin is worth 33 times more than Dogecoin, despite being a fundamentally similar creation, why couldn't T-coin be worth 50 times more than Bitcoin? At that valuation, just the premined portion of T-coin would allow the US Government to pay-off almost all of its \$36+ trillion debt. The coins which came to the Government as the system continued to run in the years which followed would contribute significantly to future spending.
