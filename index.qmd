...
* All the code for the Bitcoin blockchain is, by design, open source. There are no secrets. Nothing prevents us from copying Bitcoin down to the very last detail. We would name this new blockchain the "T-chain".
